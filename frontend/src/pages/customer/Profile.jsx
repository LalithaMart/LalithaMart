            ...
            >
              ...
              >
                ...
                <div className="mt-4 sm:mt-0 sm:text-right flex flex-col sm:items-end">
                  ...
                  <span className={`inline-flex items-center px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest shadow-sm whitespace-nowrap inline-block
